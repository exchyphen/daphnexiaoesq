      ...
      <section className="text__main">
        ...
        <div className="text__main--section">
          ...
          <p>
            ...
            , a Sacramento attorney who provides results-oriented representation
            on behalf of people seeking legal residency in the U.S. I work hard
            to achieve my clients’ goals in an efficient, timely and
        ...
        <div className="text__main--section">
          ...
          <p>
            ...
            information that U.S. Citizenship and Immigration Services requires.
            When I handle your case, I will take care to do things right the
            first time to avoid delays. I will also review your situation for
            potential problems and take measures to resolve those problems. As
            the process moves forward, I will keep you informed of important
            developments and respond promptly when you call.
          </p>
        </div>
      </section>
      <Footer></Footer>
