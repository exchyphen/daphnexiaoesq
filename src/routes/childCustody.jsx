      ...
      <section className="text__main">
        ...
        <div className="text__main--section">
          ...
          <p>
            ...
            child custody and visitation solutions that are in the best interest
            of children and to help my clients be the best parents they can be.
          </p>
        ...
        <div className="text__main--section">
          ...
          <p>
            In California, there is no standard formula for deciding custody or
            visitation matters. Instead, courts make their decisions based on
            what they perceive to be the “best interest” of the child. This
            means the court can choose from a range of solutions that are based
            on the needs of the child. These solutions can also change over time
            as the child matures and his or her needs change.
          </p>
          <p>
            ...
            visitation arrangements. Let me put my experience and skills to work
            for you.
          </p>
        </div>
      </section>
