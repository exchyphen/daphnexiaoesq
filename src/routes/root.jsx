      ...
      <section className="text__main">
        ...
        <div className="text__main--section">
          ...
          <p>
            ...
            committed to protecting the rights of my clients and achieving their
          ...
          <p>
            ...
            up my client’s legal bills. My goal when representing you will be to
            resolve your legal problem as quickly as I can. If litigation is
            necessary however, I will work tirelessly to obtain results for you
        ...
        <div className="text__main--section">
          ...
          <p>
            <span className="text__bold">Responsive service</span> — I will keep
            you fully informed of important developments in your case and
        ...
        <div className="text__main--section">
          ...
          <p>
            For a consultation about your legal problem, call the Law Office of
            Daphne Z. Xiao at{" "}
